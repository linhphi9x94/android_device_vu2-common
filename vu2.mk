...
# This file includes all definitions that apply to ALL fx1skhrc devices, and
# are also specific to fx1skhrc devices
#
...
PRODUCT_COPY_FILES += \
        $(LOCAL_PATH)/nfc.default.so:system/lib/hw/nfc.default.so \
        $(LOCAL_PATH)/camera.vendor.msm8960.so:system/lib/hw/camera.vendor.msm8960.so \
        $(LOCAL_PATH)/BCM4334B0_002.001.013.0271.0333.hcd:/system/vendor/firmware/BCM4334B0_002.001.013.0271.0333.hcd

PRODUCT_COPY_FILES += \
        $(LOCAL_PATH)/init.fx1sk-common.rc:root/init.fx1sk-common.rc \
        $(LOCAL_PATH)/init.fx1sk.usb.rc:root/init.fx1sk.usb.rc
